---
name: ccc
description: Claude Code Concierge — タスク内容に最適な Claude Code 組み込み機能・コンテキスト・プラグイン・スキル・エージェント・Hook・LSP・Monitor・Output Style・MCP サーバーの組み合わせをローカルカタログ(RAG)から検索して提案する。使い方 /ccc <やりたいタスク>（/c3 でも可）。Web 調査は原則行わずクレジット消費を最小化する。
---
